...
export const NO_PEOPLE_HERE = "There is no people here. Invite your friends to join!"
export const NO_MORE_POSTS = "There are no more posts. Create your own!"
export const NO_MORE_FRIENDS = "There are no more friends."
